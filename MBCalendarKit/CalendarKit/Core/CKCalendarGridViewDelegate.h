 ...
 */
- (void)calendarGrid:(nonnull CKCalendarGridView *)gridView willDisplayCell:(nonnull CKCalendarCellBase *)cell forDate:(nonnull NSDate *)date atIndexpath:(nonnull NSIndexPath *)indexPath;
